...
export const PLEASE_ENTER_FIRST_NAME = `Please enter valid first name!`;
export const PLEASE_ENTER_LAST_NAME = `Please enter valid last name!`;
...
export const PASSWORD_NOT_MATCH = `Passwords doesn't not match`;

      ...
      if(this.props.airlinesDetail && this.props.airlinesDetail !== prevProps.airlinesDetail && this.props.screenType == "FIND_FLIGHT"){
        ...
        if(searchDetails && Object.keys(searchDetails).length !== 0){
          if(searchDetails && searchDetails.searchCount < 3 || !this.props.userInfo.bronze_member){
            ...
            console.log("this.state.search dAta - -  -  - - -",this.state.searchData)
            console.log("this.props.peakOffpeakData - -  -  - - -",this.props.peakOffpeakData)
            ...
            // Alert.alert("YES DONE FOR THIS SCREEN")
            this.props.navigation.navigate(STRING_CONST.CALENDAR_SCREEN, {
            ...
            console.log("yes check here on search details before 3 - - - - -  - -")
            ...
            if(this.props.userInfo.bronze_member && searchDetails.searchCount >= 3){
              ...
              console.log("yes checking on else part - - - - - - - - - - -  - - - --  - -- - - - - - - - - - - - - - - - - - - --- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -")
              console.log("this.state.search dAta - -  -  - - -",this.state.searchData)
              console.log("this.props.peakOffpeakData - -  -  - - -",this.props.peakOffpeakData)

...
//         MAP_TOKEN ? MAP_TOKEN : CONFIG.MAPBOX_TOKEN
//       );
...
//     }
//     // console.log("yes print finalize array  -   - - - - -",cabinClasses)
...
//     //   <View style={{ borderColor: colours.black, borderWidth: 0, width: 30 }}>
//     //     <Image source={IMG_CONST.MAP_LOCATION_PIN} style={{ height: scale(44), width: scale(30) }} />
//     //   </View>
//     // );
...
//         {/* <TouchableOpacity style={{position:"absolute",top:scale(300),bottom:scale(30),left:scale(30),right:scale(40),}} onPress={()=>{
...
//     mapBoxToken:mapKeyReducer.MapKeyData
